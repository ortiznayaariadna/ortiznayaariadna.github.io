<?php
	...
	*/
	...
	$email_to = "info@ariportfolio.co.uk"; 			// Specify the email address you want to send the mail to.
	$email_from = "info@ariportfolio.co.uk";  //Specify the email address that you want to send the email from. This needs to be Fasthosts hosted,
	$email_subject = "Form Submission"; 	// Set the subject of your email.
	// Specify a page on your website to display a thankyou message when the mail is sent
	$thankyou_url = "https://ariportfolio.co.uk/thankyou.html";
